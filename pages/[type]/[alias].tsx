...
export const getStaticPaths: GetStaticPaths = async () => {
  ...
  for (const m of firstLevelMenu) {
    const resMenu = await fetch(process.env.NEXT_PUBLIC_DOMAIN + "/api/top-page/find", {
      method: "POST",
      headers: {
...
export const getStaticProps: GetStaticProps<TopPageProps> = async ({ params }: GetStaticPropsContext<ParsedUrlQuery>) => {
  ...
  try {
    ...
    const resPage = await fetch(process.env.NEXT_PUBLIC_DOMAIN + "/api/top-page/byAlias/" + params.alias);
